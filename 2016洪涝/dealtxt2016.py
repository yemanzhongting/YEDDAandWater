...
with open('2016洪涝结果','r+',encoding='utf-8') as f:
    tmp=f.readlines()
...
labelsBIO1=['B-Waterlog-Location\n','I-Waterlog-Location\n']
labelsBIO2=['B-Drainage-Location\n','I-Drainage-Location\n']
labelsBIO3=['B-Easy-Waterlog-Location\n','I-Easy-Waterlog-Location\n']
labelsBIO4=['B-Recession-Location\n','I-Recession-Location\n']
labelsBIOs=[labelsBIO1,labelsBIO2,labelsBIO3,labelsBIO4]

for labelsBIO in labelsBIOs:
    for i in tmp:
        try:
            if i!='':
                # print(i)
                if zt==False:
                    if i.split(' ')[1]==labelsBIO[0]:
                        print('zhuadao')
                        zt=True
                        tmp_Area=""
                        tmp_Area=i.split(' ')[0]
